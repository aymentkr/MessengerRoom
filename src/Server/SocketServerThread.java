...
public class SocketServerThread implements Runnable {
    ...
    private void onChatMessage(ChatMessage message) throws IOException {
        // Process the incoming chat message here
        System.out.println("Received message from " + message.getSenderName() + ": " + message.getMessage());

        // You can broadcast the message to all clients or send it to specific rooms/members
